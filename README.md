...
```shell
git clone https://github.com/milindhvijay/milindhvijay-blog
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/milindhvijay-blog/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://milindhvijay.github.io/milindhvijay-blog'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/milindhvijay/milindhvijay-blog
  - link: https://github.com/milindhvijay/milindhvijay-blog#readme
...
`https://milindhvijay.github.io/milindhvijay-blog`